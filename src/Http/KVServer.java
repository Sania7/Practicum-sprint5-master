...
public class KVServer {
    ...
    private void load(HttpExchange h) throws IOException {
        ...
        try {
            System.out.println("\n/load");
            if (!hasAuth(h)) {
                System.out.println("Запрос неавторизован, нужен параметр в query APY_KEY со значение апи-ключа.");
            ...
            if ("GET".equals(h.getRequestMethod())) {
                ...
                if (!data.containsKey(key)) {
                    System.out.println("Key по ключу пустой.");
    ...
    public void register(HttpExchange h) throws IOException {
        try {
            System.out.println("\n/register");
            if ("GET".equals(h.getRequestMethod())) {
                sendText(h, apiToken);
